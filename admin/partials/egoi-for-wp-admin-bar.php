...
if(isset($_POST['action'])){
	echo '<div class="updated notice is-dismissible"><p>';
		_e('Bar Updated!', 'egoi-for-wp');
	echo '</p></div>';
}
?>

<h1 class="logo">Smart Marketing - <?php _e( 'Subscriber Bar', 'egoi-for-wp' ); ?></h1>
	<p class="breadcrumbs">
		<span class="prefix"><?php echo __( 'You are here: ', 'egoi-for-wp' ); ?></span>
		<strong>Smart Marketing</a> &rsaquo;
		<span class="current-crumb"><?php _e( 'Subscriber Bar', 'egoi-for-wp' ); ?></strong></span>
	</p>
...
<div class="wrap" id="egoi4wp-admin" style="width:65%;">
			...
			<div class="row">
				<div class="col col-2">
					<table class="form-table">
						...
						<tr valign="top">
							<th scope="row">
								<label>
									<?php _e( 'Bar Text Color', 'egoi-for-wp' ); ?>
								</label>
							</th>
							<td>
				...
				<div class="col col-2">
					<table class="form-table">
						...
						<tr valign="top" class="sticky-bar-options">
							<th scope="row">
								<label>
		...
		<div class="tab" id="tab-messages">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td><input type="text" class="widefat" name="egoi_bar_sync[text_error]" placeholder="<?php echo esc_attr( $this->bar_post['text_error'] ); ?>"  value="<?php echo esc_attr( $this->bar_post['text_error'] ); ?>" /></td>
				</tr>
				<tr valign="top">
					<th scope="row">
						<label>
	 ...
	 * @ignore
	 */
	do_action( 'egoi4wp_admin_footer' );
	?>
